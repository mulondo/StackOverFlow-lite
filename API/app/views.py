...
class Routes:
    ...
    def generate_routes(app):
        ...
        app.add_url_rule('/api/v1/questions', view_func=Api_controller.as_view('get_a_questions') ,methods=['GET'], strict_slashes=False)
        app.add_url_rule('/api/v1/questions/<int:question_id>', view_func=Api_controller.as_view('get_a_quest'), methods=['GET'],
